...
func (_q *ArticleQuery) QueryDomainReport() *DomainReportQuery {
...
func (_q *ArticleQuery) WithDomainReport(opts ...func(*DomainReportQuery)) *ArticleQuery {
	query := (&DomainReportClient{config: _q.config}).Query()
...
//		GroupBy(article.FieldDomainReportID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Article.Query().
//		Select(article.FieldDomainReportID).
//		Scan(ctx, &v)
...
func (_q *ArticleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Article, error) {
	...
	if query := _q.withDomainReport; query != nil {
		if err := _q.loadDomainReport(ctx, query, nodes, nil,
			func(n *Article, e *DomainReport) { n.Edges.DomainReport = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ArticleQuery) loadDomainReport(ctx context.Context, query *DomainReportQuery, nodes []*Article, init func(*Article), assign func(*Article, *DomainReport)) error {
...
func (_q *ArticleQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withDomainReport != nil {
			_spec.Node.AddColumnOnce(article.FieldDomainReportID)
		}
	}
